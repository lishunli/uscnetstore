...
/**
 	* A data access object (DAO) providing persistence and search support for Shoppingcart entities.
...
public class ShoppingcartDAO extends HibernateDaoSupport  {
    ...
    public Shoppingcart findById( java.lang.Integer id) {
        ...
        try {
            Shoppingcart instance = (Shoppingcart) getHibernateTemplate()
                    .get("com.usc.daos.Shoppingcart", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding Shoppingcart instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public Shoppingcart merge(Shoppingcart detachedInstance) {
        ...
        try {
            Shoppingcart result = (Shoppingcart) getHibernateTemplate()
