...
public class Custom  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Custom(String customName, String customPass, String email, String realName, String sex, String address, String postCode, String mobile, Float consumption, Float ucurrency, Float benefits, Integer vipFlag, Date vipDate, Integer activeFlag) {
    ...
    /** full constructor */
    public Custom(String customName, String customPass, String email, String realName, String sex, String address, String postCode, String mobile, String phone, Float consumption, Float ucurrency, Float benefits, Integer vipFlag, Date vipDate, Integer activeFlag, Set consumptiondetails, Set remarks, Set orderforms, Set latencyorderforms, Set favorites, Set blacklists, Set shoppingcarts, Set benefitsdetails, Set ucurrencydetails) {
        this.customName = customName;
        this.customPass = customPass;
        this.email = email;
        this.realName = realName;
