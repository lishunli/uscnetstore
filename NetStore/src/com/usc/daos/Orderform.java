...
public class Orderform  implements java.io.Serializable {
    ...
    /** full constructor */
    public Orderform(Custom custom, Date orderFormTime, String realName, String address, String postCode, String mobile, String phone, String orderFormState, Integer cargoListId, Set consumptiondetails, Set orderstates, Set orderproductses) {
        this.custom = custom;
        this.orderFormTime = orderFormTime;
        this.realName = realName;
        this.address = address;
