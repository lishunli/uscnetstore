...
/**
 	* A data access object (DAO) providing persistence and search support for Latencyorderform entities.
...
public class LatencyorderformDAO extends HibernateDaoSupport  {
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding Latencyorderform instance with property: " + propertyName
            + ", value: " + value);
      try {
	...
	public static LatencyorderformDAO getFromApplicationContext(ApplicationContext ctx) {
