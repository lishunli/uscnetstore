...
/**
 	* A data access object (DAO) providing persistence and search support for Commodity entities.
...
public class CommodityDAO extends HibernateDaoSupport  {
    ...
    public Commodity findById( java.lang.Integer id) {
        ...
        try {
            Commodity instance = (Commodity) getHibernateTemplate()
                    .get("com.usc.daos.Commodity", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Commodity merge(Commodity detachedInstance) {
        ...
        try {
            Commodity result = (Commodity) getHibernateTemplate()
