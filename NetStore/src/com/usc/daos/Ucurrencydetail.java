...
public class Ucurrencydetail  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Ucurrencydetail(Float last, Float current, String source, String destination, Date ucurrencyDate) {
        this.last = last;
    ...
    /** full constructor */
    public Ucurrencydetail(Custom custom, Float last, Float current, String source, String destination, Date ucurrencyDate) {
        this.custom = custom;
        this.last = last;
        this.current = current;
        this.source = source;
