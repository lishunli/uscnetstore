...
public class Benefitsdetail  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Benefitsdetail(Float last, Float current, String explanation, String type, Date benefitsDate) {
        this.last = last;
    ...
    /** full constructor */
    public Benefitsdetail(Custom custom, Float last, Float current, String explanation, String type, Date benefitsDate) {
        this.custom = custom;
        this.last = last;
        this.current = current;
        this.explanation = explanation;
