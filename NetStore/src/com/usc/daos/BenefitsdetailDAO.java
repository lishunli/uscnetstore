...
/**
 	* A data access object (DAO) providing persistence and search support for Benefitsdetail entities.
...
public class BenefitsdetailDAO extends HibernateDaoSupport  {
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding Benefitsdetail instance with property: " + propertyName
            + ", value: " + value);
      try {
	...
	public static BenefitsdetailDAO getFromApplicationContext(ApplicationContext ctx) {
