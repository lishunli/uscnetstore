...
/**
 	* A data access object (DAO) providing persistence and search support for Consumptiondetail entities.
...
public class ConsumptiondetailDAO extends HibernateDaoSupport  {
    private static final Log log = LogFactory.getLog(ConsumptiondetailDAO.class);
	//property constants
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding Consumptiondetail instance with property: " + propertyName
            + ", value: " + value);
      try {
	...
	public static ConsumptiondetailDAO getFromApplicationContext(ApplicationContext ctx) {
