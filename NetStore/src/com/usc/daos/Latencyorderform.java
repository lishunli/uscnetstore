...
public class Latencyorderform  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Latencyorderform(Date orderFormTime, String realName, String address, String postCode, String mobile, String commodityName, Integer quantity) {
    ...
    /** full constructor */
    public Latencyorderform(Custom custom, Date orderFormTime, String realName, String address, String postCode, String mobile, String phone, String commodityName, Integer quantity) {
        this.custom = custom;
        this.orderFormTime = orderFormTime;
        this.realName = realName;
        this.address = address;
