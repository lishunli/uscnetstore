...
/**
 	* A data access object (DAO) providing persistence and search support for Digital entities.
...
public class DigitalDAO extends HibernateDaoSupport  {
    ...
    public Digital findById( java.lang.Integer id) {
        ...
        try {
            Digital instance = (Digital) getHibernateTemplate()
                    .get("com.usc.daos.Digital", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Digital merge(Digital detachedInstance) {
        ...
        try {
            Digital result = (Digital) getHibernateTemplate()
