...
public class Stockin  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Stockin(Float purchasedPrice, Integer stockInQuantity, Date stockInTime) {
    ...
    /** full constructor */
    public Stockin(Operator operator, Products products, Float purchasedPrice, Integer stockInQuantity, String supplier, Date stockInTime, String remark) {
