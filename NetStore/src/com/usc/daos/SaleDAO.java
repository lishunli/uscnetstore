...
/**
 	* A data access object (DAO) providing persistence and search support for Sale entities.
...
public class SaleDAO extends HibernateDaoSupport  {
    ...
    public Sale findById( java.lang.Integer id) {
        ...
        try {
            Sale instance = (Sale) getHibernateTemplate()
                    .get("com.usc.daos.Sale", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Sale merge(Sale detachedInstance) {
        ...
        try {
            Sale result = (Sale) getHibernateTemplate()
