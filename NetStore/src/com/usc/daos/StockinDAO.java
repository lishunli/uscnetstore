...
/**
 	* A data access object (DAO) providing persistence and search support for Stockin entities.
...
public class StockinDAO extends HibernateDaoSupport  {
    ...
    public Stockin findById( java.lang.Integer id) {
        ...
        try {
            Stockin instance = (Stockin) getHibernateTemplate()
                    .get("com.usc.daos.Stockin", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Stockin merge(Stockin detachedInstance) {
        ...
        try {
            Stockin result = (Stockin) getHibernateTemplate()
