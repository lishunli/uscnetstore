...
public class Orderproducts  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Orderproducts(Integer commodityId, Float shoppingPrice, Integer quantity) {
    ...
    /** full constructor */
    public Orderproducts(Orderform orderform, Integer commodityId, Float shoppingPrice, Integer quantity) {
