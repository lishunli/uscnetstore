...
/**
 	* A data access object (DAO) providing persistence and search support for Blacklist entities.
...
public class BlacklistDAO extends HibernateDaoSupport  {
    ...
    public Blacklist findById( java.lang.Integer id) {
        ...
        try {
            Blacklist instance = (Blacklist) getHibernateTemplate()
                    .get("com.usc.daos.Blacklist", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Blacklist merge(Blacklist detachedInstance) {
        ...
        try {
            Blacklist result = (Blacklist) getHibernateTemplate()
