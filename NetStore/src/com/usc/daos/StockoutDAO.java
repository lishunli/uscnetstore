...
/**
 	* A data access object (DAO) providing persistence and search support for Stockout entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see com.usc.daos.Stockout
  * @author MyEclipse Persistence Tools 
 */

public class StockoutDAO extends HibernateDaoSupport  {
    private static final Log log = LogFactory.getLog(StockoutDAO.class);
	//property constants
	public static final String STOCK_OUT_QUANTITY = "stockOutQuantity";
    ...
    public Stockout findById( java.lang.Integer id) {
        log.debug("getting Stockout instance with id: " + id);
        try {
            Stockout instance = (Stockout) getHibernateTemplate()
                    .get("com.usc.daos.Stockout", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Stockout instance) {
	...
	public List findByStockOutQuantity(Object stockOutQuantity
	) {
		return findByProperty(STOCK_OUT_QUANTITY, stockOutQuantity
		);
	}
    ...
    public Stockout merge(Stockout detachedInstance) {
        ...
        try {
            Stockout result = (Stockout) getHibernateTemplate()
