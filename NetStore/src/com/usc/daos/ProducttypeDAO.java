...
/**
 	* A data access object (DAO) providing persistence and search support for Producttype entities.
...
public class ProducttypeDAO extends HibernateDaoSupport  {
    ...
    public Producttype findById( java.lang.Integer id) {
        ...
        try {
            Producttype instance = (Producttype) getHibernateTemplate()
                    .get("com.usc.daos.Producttype", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Producttype merge(Producttype detachedInstance) {
        ...
        try {
            Producttype result = (Producttype) getHibernateTemplate()
	...
	public static ProducttypeDAO getFromApplicationContext(ApplicationContext ctx) {
